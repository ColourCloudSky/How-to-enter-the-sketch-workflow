...
## 一、软件安装
下载破解版或者去淘宝购买激活码，当然土豪的话还是建议去官网购买正版。
由于sketch官方对软件的更新非常频繁，不建议去找破解版。直接去淘宝购买激活码激活最好，也就几块钱。
## 二、工作前期准备
### 1）插件选择
 ...
 * 1）色彩管理：
Sketch导入图片和导出图片，色彩会发生变化。
探索了很久，解决了导入问题。但导出图片，比如预览图，仍然会变色。
解决方案：将图片转成eps格式再导入就不会变色了。但是在一般界面设计时，这个问题可以忽略。
